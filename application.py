...
from src.aswwu.route_handlers import mask as mask, volunteers as volunteers, instagram as instagram, forms as forms, \
    pages as pages, froala_images as froala, homepage as homepage, elections as elections
