...
class Archive1718(ArchiveBase):
    __tablename__ = 'archives_profiles1718'
    id = Column(String(50), primary_key=True)


class Archive1617(ArchiveBase):
    __tablename__ = 'archives_profiles1617'
    id = Column(String(50), primary_key=True)


class Archive1516(ArchiveBase):
    __tablename__ = 'archives_profiles1516'
    id = Column(String(50), primary_key=True)


class Archive1415(ArchiveBase):
    __tablename__ = 'archives_profiles1415'
    id = Column(String(50), primary_key=True)
...
class Archive1314(ArchiveBase):
    __tablename__ = 'archives_profiles1314'
    id = Column(String(50), primary_key=True)


class Archive1213(ArchiveBase):
    __tablename__ = 'archives_profiles1213'
    id = Column(String(50), primary_key=True)


class Archive1112(ArchiveBase):
    __tablename__ = 'archives_profiles1112'
    id = Column(String(50), primary_key=True)


class Archive1011(ArchiveBase):
    __tablename__ = 'archives_profiles1011'
    id = Column(String(50), primary_key=True)


class Archive0910(ArchiveBase):
    __tablename__ = 'archives_profiles0910'
    id = Column(String(50), primary_key=True)


class Archive0809(ArchiveBase):
    __tablename__ = 'archives_profiles0809'
    id = Column(String(50), primary_key=True)


class Archive0708(ArchiveBase):
    __tablename__ = 'archives_profiles0708'
    id = Column(String(50), primary_key=True)


class Archive0607(ArchiveBase):
    __tablename__ = 'archives_profiles0607'
    id = Column(String(50), primary_key=True)
